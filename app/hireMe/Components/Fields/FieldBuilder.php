<?php namespace hireMe\Components\Fields;
...
class FieldBuilder
{
    ...
    public function defaultClass($type)
    {
    ...
    {
        $defaultClasses = $this->defaultClass($type);
    ...
    public function buildControl($type, $name, $value = null, $attribute = array(), $options = null)
    {
        switch ($type) {
            case 'select':
                $options = array('' => 'Seleccione') + $options;
                return $this->form->select($name, $options, $value, $attribute);
            case 'password':
                return $this->form->password($name, $attribute);
            case 'checkbox':
                return $this->form->checkbox($name);
            case 'input':
                return $this->form->text($type, $name, $value, $attribute);
            case 'textarea' :
                return $this->form->textarea($name,$value,$attribute);
            default:
                return $this->form->input($type, $name, $value, $attribute);
        }
    }
    ...
    public function input($type, $name, $value = null, $attribute = array(), $options = null)
    {
    ...
    public function select($name,$option,$value = null, $attributes = array() ){
        return $this->input('select',$name,$value,$attributes,$option);
    }
